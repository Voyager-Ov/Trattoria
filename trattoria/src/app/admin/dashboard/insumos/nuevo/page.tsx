    ...
    <div className="flex flex-col gap-8 p-8 bg-zinc-50 min-h-screen">
      ...
      <div className="flex justify-between items-center bg-white p-8 rounded-[2.5rem] border border-zinc-200 shadow-sm">
        <div>
          ...
          <p className="text-zinc-500 mt-2 font-medium">Carga un insumo con categoria relacional y costos base.</p>
        </div>
        ...
        <div className="space-y-6">
          <div className="bg-white p-8 rounded-[2.5rem] border border-zinc-200 shadow-sm">
            ...
            <div className="p-6 bg-zinc-50 rounded-[2rem] border border-zinc-100 space-y-3">
              <p className="font-black uppercase text-zinc-900">{nombre || "Pendiente"}</p>
          ...
          <Button type="submit" disabled={loading || !nombre.trim()} className="h-16 w-full rounded-2xl bg-zinc-900 text-white font-black text-lg">
