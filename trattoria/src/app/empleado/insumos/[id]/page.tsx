...
import { getSupplyById } from "@/app/admin/dashboard/insumos/actions";
import { formatArCurrencyDetailed, getCategoryColor } from "@/app/admin/dashboard/insumos/components/supplies-shared";
        ...
        <div className="app-page-safe-bottom flex min-h-screen flex-col gap-6 bg-white px-4 py-4 sm:px-6 md:px-8 md:py-8">
            ...
            <section className="space-y-4">
                <div className="flex items-start justify-between gap-3">
                    <Link href="/empleado/insumos" className="inline-flex items-center gap-2 text-sm font-semibold text-zinc-500 hover:text-zinc-900">
                        <ChevronLeft className="h-4 w-4" /> Volver
                    </Link>
                    <div className="hidden items-center gap-3 sm:flex">
                        <Link href={`/empleado/insumos/stock?id=${s.id}`}>
                            <Button variant="outline" className="rounded-full border-zinc-200">
                                <PackagePlus className="mr-2 h-4 w-4" /> Registrar stock
                            </Button>
                        </Link>
                        <Link href={`/empleado/insumos/${s.id}/editar`}>
                            <Button variant="outline" className="rounded-full border-zinc-200">
            ...
            <section className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div className="rounded-[1.5rem] border border-zinc-200 bg-white p-4 shadow-sm">
                    <p className="text-[11px] font-black uppercase tracking-[0.16em] text-zinc-400">Flujo total de mercadería</p>
