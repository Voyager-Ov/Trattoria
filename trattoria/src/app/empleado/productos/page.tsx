            ...
            <section className="space-y-4">
                <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                    ...
                    <div className="flex w-full flex-wrap gap-3 lg:w-auto">
                        ...
                        >
                            <Link href="/empleado/productos/categorias" className="flex items-center gap-2">
                        ...
                        <Button
                            ...
                            className="h-11 rounded-2xl border-zinc-200 bg-white px-4 font-medium text-zinc-700 shadow-sm md:rounded-full md:px-5"
                        >
                            <Link href="/empleado/productos/opciones" className="flex items-center gap-2">
                                <ListTree className="h-4 w-4" />
                                Opciones
                            </Link>
                        </Button>
                        ...
                        <Button asChild className="h-11 rounded-2xl bg-zinc-900 text-white hover:bg-zinc-800 md:rounded-full">
                            <Link href="/empleado/productos/promociones/nueva">
                        ...
                        <Button asChild className="h-11 rounded-2xl bg-orange-500 text-white hover:bg-orange-600 md:rounded-full">
                            <Link href="/empleado/productos/nuevo">
                                <Plus className="mr-2 h-4 w-4" />
                                Nuevo producto
                            </Link>
                        </Button>
                                            ...
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end" className="w-48 rounded-2xl border-zinc-100 p-2 shadow-xl">
                                                    <DropdownMenuItem asChild className="my-0.5 rounded-xl">
                                                        <Link href={item.type === "PRODUCTO" ? `/empleado/productos/${item.id}` : `/empleado/productos/promociones/${item.id}`}>
                                                            Ver detalle
                                                        </Link>
                                                    </DropdownMenuItem>
                                                    <DropdownMenuItem asChild className="my-0.5 rounded-xl">
                                                        <Link
                                                            href={
                                                                item.type === "PRODUCTO"
                                                                    ? `/empleado/productos/${item.id}/editar`
                                                                    : `/empleado/productos/promociones/${item.id}/editar`
                                                            }
                                                        >
                                                            Editar
                                                        </Link>
                        ...
                        <div className="grid grid-cols-1 gap-3">
                                ...
                                <Link
                                    href={
                                        selectedItem.type === "PRODUCTO"
                                            ? `/empleado/productos/${selectedItem.id}`
                                            : `/empleado/productos/promociones/${selectedItem.id}`
                                    }
                                >
                            ...
                            <Button asChild variant="outline" className="h-11 rounded-2xl border-zinc-200">
                                <Link
                                    href={
                                        selectedItem.type === "PRODUCTO"
                                            ? `/empleado/productos/${selectedItem.id}/editar`
                                            : `/empleado/productos/promociones/${selectedItem.id}/editar`
                                    }
                                >
