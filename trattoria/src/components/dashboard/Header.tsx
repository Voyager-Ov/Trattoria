...
export function Header() {
    ...
    return (
        <header className="app-header-safe sticky top-0 z-30 flex min-h-16 items-end gap-3 border-b border-zinc-200/70 bg-white/90 pb-3 backdrop-blur-xl md:min-h-20 md:items-center md:pb-0">
